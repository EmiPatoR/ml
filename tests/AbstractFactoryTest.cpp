...
//
#define BOOST_TEST_MODULE AbstractFactoryTests
...
struct Fixture {
    Fixture() {
        ...
        testFactory.Register("TestObj", [](int arg1, float arg2, std::string arg3) {
            return std::unique_ptr<TestObj>(new TestObj(arg1, arg2, arg3));
        });
    }
...
BOOST_CHECK( testFactory
.m_map.count("TestObj") == 1);
}
